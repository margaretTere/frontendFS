...
var invariant3 = Object.assign(function invariant4(condition, message) {
  ...
  debug: wrap2(invariant.debug),
  log: wrap2(invariant.log),
  warn: wrap2(invariant.warn),
  error: wrap2(invariant.error)
});
...
function toPromise(observable) {
  ...
  return new Promise(function(resolve, reject) {
    observable.subscribe({
      next: function(data) {
        if (completed) {
          globalThis.__DEV__ !== false && invariant3.warn(45);
        } else {
          completed = true;
          resolve(data);
        }
...
//# sourceMappingURL=chunk-PIJFAQDK.js.map
